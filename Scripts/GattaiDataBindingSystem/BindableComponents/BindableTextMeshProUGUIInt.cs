...
{
    /// <summary>
    /// This class represents a Unity component that can be bound to a <see cref="BindableInt"/> variable.
    ...
    /// </summary>
    public class BindableTextMeshProUGUIInt : BindableComponent<TextMeshProUGUI, BindableInt>
    {
        /// <summary>
